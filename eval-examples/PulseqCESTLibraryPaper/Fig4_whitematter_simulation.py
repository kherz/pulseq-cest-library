...
parser.add_argument('bmsim_filename', type=str, nargs='?', default='/Users/alexliebeskind/Desktop/pulseq-cest-library/sim-library/WM_3T_001_bmsim.yaml',
...
if data_flag == 'simulation':
    ...
    config_path = Path.cwd().parent.parent / "Desktop" / "pulseq-cest-library" / "sim-library" / "WM_3T_001_bmsim.yaml"

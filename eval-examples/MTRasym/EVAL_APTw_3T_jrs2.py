...
def main(data_flag, data_path, bmsim_filename, seq_filename):
    ...
    if __name__ == "__main__":
        ...
        parser.add_argument('data_flag', type=str, nargs='?', default='simulation', help="Type of data to process: 'simulation', 're_simulation', or 'real_data'")
        parser.add_argument('data_path', type=str, nargs='?', default='', help="Path to the data directory")
        parser.add_argument('bmsim_filename', type=str, nargs='?', default='WM_3T_default_7pool_bmsim.yaml', help="Filename of the BMSim configuration file")
        parser.add_argument('seq_filename', type=str, nargs='?', default='APTw_3T_001_2uT_36SincGauss_DC90_2s_braintumor.seq', help="Filename of the sequence file")

        args = parser.parse_args()
        main(args.data_flag, args.data_path, args.bmsim_filename, args.seq_filename)
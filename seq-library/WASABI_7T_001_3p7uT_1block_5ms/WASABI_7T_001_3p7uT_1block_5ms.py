...
# WASABI protocol with 31 offsets and one M0 image at 7T according to: https://doi.org/10.1002/mrm.26133
#
...
defs["offsets_ppm"] = np.append(defs["m0_offset"], np.linspace(-1.5, 1.5, 31))
